 ...
 * @brief Motor Control Framework configuration - BRD4120A overlay
 *******************************************************************************
 * # License
...
// <h> Pin map (BRD4120A wiring. Use 'NA' for not applicable.)
...
// <s.16 SPI_CS> SPI chip select (DRV8305)
// <d> "PC8"
#define SPI_CS        PC8

// DRV8305 SPI chip-select GPIO (raw EMLIB port/pin form used by motor_control.cpp)
#define DRV_SPI_CS_PORT   gpioPortC
#define DRV_SPI_CS_PIN    8
